...
public class PlasticDetergentBottle extends TrashElement {
    private final TrashContainerElement correctContainer;
    private Action movement;

    public PlasticDetergentBottle(Texture texture, int x, int y, TrashContainerElement correctContainer, Array<TrashContainerElement> containers) {
        super(texture, WasteType.PLASTIC_DETERGENT_BOTTLE, new Rectangle(x, y, texture.getWidth(), texture.getHeight()), x, y);
