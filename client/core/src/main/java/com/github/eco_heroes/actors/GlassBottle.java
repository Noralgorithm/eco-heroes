...
public class GlassBottle extends TrashElement {
    private final TrashContainerElement correctContainer;
    private Action movement;

    public GlassBottle(Texture texture, int x, int y, TrashContainerElement correctContainer, Array<TrashContainerElement> containers) {
        super(texture, WasteType.GLASS_BOTTLE, new Rectangle(x, y, texture.getWidth(), texture.getHeight()), x, y);
        ...
        addListener(new DragListener() {
            ...
            public void dragStop(InputEvent event, float x, float y, int pointer) {
                ...
                if (droppedOverNothing()){
                    ...
                    System.out.println("¡La glass bottle ha sido colocada en el contenedor!");
                    remove();
                } else {
                    wrongSound.play();
