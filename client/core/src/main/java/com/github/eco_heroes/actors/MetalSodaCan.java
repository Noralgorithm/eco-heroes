...
public class MetalSodaCan extends TrashElement {
    private final TrashContainerElement correctContainer;
    private Action movement;

    public MetalSodaCan(Texture texture, int x, int y, TrashContainerElement correctContainer, Array<TrashContainerElement> containers) {
        super(texture, WasteType.METAL_SODA_CAN, new Rectangle(x, y, texture.getWidth(), texture.getHeight()), x, y);
        ...
        addListener(new DragListener() {
            ...
            public void dragStop(InputEvent event, float x, float y, int pointer) {
                ...
                if (droppedOverNothing()){
                    ...
                    System.out.println("¡La metal soda can ha sido colocada en el contenedor!");
                    remove();
                } else {
                    wrongSound.play();
