...
public class PaperBag extends TrashElement {
    private final TrashContainerElement correctContainer;
    private Action movement;

    public PaperBag(Texture texture, int x, int y, TrashContainerElement correctContainer, Array<TrashContainerElement> containers) {
        super(texture, WasteType.PAPER_BAG, new Rectangle(x, y, texture.getWidth(), texture.getHeight()), x, y);
        ...
        addListener(new DragListener() {
            ...
            public void dragStop(InputEvent event, float x, float y, int pointer) {
                ...
                if (droppedOverNothing()){
                    ...
                    System.out.println("¡La paper bag ha sido colocada en el contenedor!");
                    remove();
                } else {
                    wrongSound.play();
