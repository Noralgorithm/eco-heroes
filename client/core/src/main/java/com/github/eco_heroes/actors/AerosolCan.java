...
public class AerosolCan extends TrashElement {
    private final TrashContainerElement correctContainer;
    private Action movement;

    public AerosolCan(Texture texture, int x, int y, TrashContainerElement correctContainer, Array<TrashContainerElement> containers) {
        super(texture, WasteType.AEROSOL_CAN, new Rectangle(x, y, texture.getWidth(), texture.getHeight()), x, y);
