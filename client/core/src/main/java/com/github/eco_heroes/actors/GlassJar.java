...
public class GlassJar extends TrashElement {
    private final TrashContainerElement correctContainer;
    private Action movement;

    public GlassJar(Texture texture, int x, int y, TrashContainerElement correctContainer, Array<TrashContainerElement> containers) {
        super(texture, WasteType.GLASS_JAR, new Rectangle(x, y, texture.getWidth(), texture.getHeight()), x, y);
